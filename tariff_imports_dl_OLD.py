...
FILE_PATH = 'C:/Users/' + str(os.environ['USERPROFILE'].rsplit('\\',1)[-1]) + '/Desktop/' + 'tariff_imports_' 
FILE_PATH += str(datetime.date.today())
...
def group_data(df):
    ...
    df_group.to_excel(FILE_PATH + '.xlsx', index=False)
